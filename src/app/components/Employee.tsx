      ...
      <main className="pt-16 pb-24">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="mb-8 flex flex-wrap gap-4 border-b-4 border-black pb-4">
            ...
            <button
              disabled
              className="px-6 py-3 border-2 border-black font-black uppercase text-sm bg-neutral-200 text-neutral-500 cursor-not-allowed opacity-50"
            >
              User Management
            </button>
            <button
          ...
          <div className="mt-8">
              ...
              <div>
                ...
                {leads.length === 0 ? (
                  <div className="text-center py-12 border-4 border-black">
                    <p className="font-mono text-lg">No leads assigned to you yet</p>
                  </div>
                ) : (
                          ...
                          <div className="flex flex-col items-end gap-2">
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                ...
                                className="p-2 border-2 border-black bg-white hover:bg-[#30578e] hover:text-white transition-colors"
            ...
            {activeSection === 'tasks' && (
              <div className="text-center py-12 border-4 border-black">
                <p className="font-mono text-lg">No tasks assigned yet</p>
              </div>
            )}
            
            {activeSection === 'profile' && user && (
              <div className="border-4 border-black p-8 bg-white max-w-2xl">
                <h2 className="text-3xl font-black uppercase mb-6">Profile</h2>
                <div className="space-y-4">
                  <div>
                    <div className="font-bold uppercase text-sm mb-2">Email</div>
                    <div className="font-mono text-lg">{user.email}</div>
                  </div>
                  <div>
                    <div className="font-bold uppercase text-sm mb-2">Role</div>
                    <div className="font-mono text-lg">{user.role}</div>
                  </div>
                </div>
              </div>
            )}
        ...
        {showQuotationModal && selectedLead && (
          ...
          >
            <motion.div
              ...
              className="bg-white border-4 border-black shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Modal Header */}
              <div className="flex items-center justify-between p-6 border-b-4 border-black">
                <h2 className="text-2xl font-black uppercase">Create your customized quotation for requirement</h2>
                <div className="flex gap-2">
                  <button
                    onClick={() => handleCloseQuotationModal()}
                    className="p-2 border-2 border-black hover:bg-black hover:text-white transition-colors"
              ...
              <div className="flex flex-1 overflow-hidden">
                ...
                <div className="w-64 border-r-4 border-black bg-neutral-50 p-6 overflow-y-auto">
                  <div className="space-y-2">
                    {[1, 2, 3, 4].map((step) => (
                      <button
                        ...
                        className={`w-full text-left p-4 border-2 border-black font-bold uppercase transition-all ${
                          currentStep === step
                            ? 'bg-black text-white shadow-[4px_4px_0px_0px_#30578e]'
                ...
                <div className="flex-1 p-8 overflow-y-auto">
                  ...
                  {currentStep === 1 && (
                    <div className="space-y-6">
                      <div className="flex items-center justify-between mb-6">
                        <h3 className="text-2xl font-black uppercase">Select Product</h3>
                        <div className="flex gap-2">
                          <button
                      ...
                      <div className="flex gap-4 mb-6">
                        <button
                          ...
                          className="px-4 py-2 border-2 border-black bg-white text-black hover:bg-black hover:text-white transition-colors font-bold uppercase text-sm"
                        >
                          Select All
                        </button>
                        <button
                        ...
                        <button
                          ...
                          className="px-4 py-2 border-2 border-black bg-black text-white hover:bg-white hover:text-black transition-colors font-bold uppercase text-sm flex items-center gap-2"
                        >
                          <Plus size={16} />
                          Add Product
                        </button>
                      ...
                      <div className="space-y-4">
                        {products.map((product) => (
                          <div key={product.id} className="border-4 border-black p-6 bg-white">
                            <div className="flex items-start gap-4 mb-4">
                              ...
                              <button
                                ...
                                className="ml-auto p-2 border-2 border-black hover:bg-red-600 hover:text-white transition-colors"
                              >
                                <X size={16} />
                              </button>
                            </div>
                            
                            <div className="mb-4 w-32 h-32 border-2 border-black bg-neutral-100 flex items-center justify-center">
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  <label className="block font-bold uppercase text-sm mb-2">Quantity</label>
                                  <input
                                    type="number"
                                    min="1"
                                ...
                                <div>
                                  ...
                                  <div className="flex">
                                    <span className="border-2 border-r-0 border-black p-3 font-bold">{currency}</span>
                                    <input
                                      type="number"
                                      value={product.price}
                                      onChange={(e) => handleProductChange(product.id, 'price', e.target.value)}
                                      className="flex-1 border-2 border-black p-3 font-mono focus:outline-none focus:bg-black focus:text-white transition-colors"
                                    />
                                    <span className="border-2 border-l-0 border-black p-3 font-bold">{currency}</span>
                                  </div>
                                </div>
                              </div>
                              
                              <div>
                                <label className="block font-bold uppercase text-sm mb-2">Unit</label>
                                <input
                                  type="text"
                                  value={product.unit}
                                  ...
                                  className="w-full border-2 border-black p-3 font-mono focus:outline-none focus:bg-black focus:text-white transition-colors"
                                />
                                <span className="text-sm font-mono text-neutral-500">/ Unit</span>
                              </div>
                            </div>
                          </div>
                        ))}
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-6">
                      <h3 className="text-2xl font-black uppercase mb-6">Terms & Conditions</h3>
                      
                      <div className="space-y-4">
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Discount</label>
                          <div className="flex">
                            <input
                              type="number"
                              ...
                              className="flex-1 border-2 border-black p-3 font-mono focus:outline-none focus:bg-black focus:text-white transition-colors"
                            />
                            <span className="border-2 border-l-0 border-black p-3 font-bold">%</span>
                          </div>
                        </div>
                        
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Applicable Taxes</label>
                          ...
                          <label className="flex items-center gap-2">
                            ...
                            />
                            <span className="font-mono text-sm">Included in product price</span>
                          </label>
                        </div>
                        
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Shipping Charges (Incl. GST)</label>
                          <div className="flex gap-2 mb-2">
                            <input
                              type="number"
                        ...
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Delivery Period</label>
                          <div className="flex gap-2">
                            <select
                              value={termsData.deliveryPeriod}
                              onChange={(e) => handleTermsChange('deliveryPeriod', e.target.value)}
                              className="border-2 border-black p-3 font-mono focus:outline-none focus:bg-black focus:text-white transition-colors"
                            >
                        ...
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Payment Terms</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Additional Information</label>
                          <textarea
                        ...
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Attach Documents (Max 4)</label>
                          <input
                            type="file"
                            multiple
                              ...
                              {termsData.documents.map((doc, idx) => (
                                <div key={idx} className="flex items-center justify-between p-2 border-2 border-black bg-neutral-50">
                                  ...
                                  <button
                                    ...
                                    className="p-1 border-2 border-black hover:bg-red-600 hover:text-white transition-colors"
                                  >
                                    <X size={14} />
                                  </button>
                                </div>
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6">
                      <h3 className="text-2xl font-black uppercase mb-6">Verify Details</h3>
                      
                      <div className="space-y-4">
                        <div>
                          <label className="block font-bold uppercase text-sm mb-2">Primary Email</label>
                          <input
                            type="email"
                        ...
                        <div className="space-y-2">
                          <label className="block font-bold uppercase text-sm">Phone Numbers</label>
                          <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          <label className="block font-bold uppercase text-sm">Address</label>
                          <select
                        ...
                        <div className="p-4 border-2 border-black bg-neutral-50">
                          <p className="font-mono text-sm">Note: Above details will be displayed in the quotation</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {currentStep === 4 && (
                    <div className="space-y-6">
                      <h3 className="text-2xl font-black uppercase mb-6">Generate PDF</h3>
                      ...
                      {pdfGenerated && pdfUrl ? (
                        ...
                        <div className="text-center py-12 border-4 border-black">
                          <button
                            ...
                            className="px-8 py-4 border-2 border-black bg-black text-white hover:bg-white hover:text-black transition-colors font-bold uppercase disabled:opacity-50"
                          >
              ...
              {/* Modal Footer */}
              <div className="p-6 border-t-4 border-black bg-neutral-50 flex items-center justify-between">
                <div className="flex gap-4 items-center w-full">
                  {currentStep > 1 && (
                    <button
                      onClick={handleBackStep}
                      disabled={pdfGenerated && currentStep === 4}
                      className={`px-6 py-3 border-2 border-black font-bold uppercase flex items-center gap-2 transition-colors ${
                  ...
                  {currentStep < 4 && (
                    <button
                      ...
                      className="px-6 py-3 border-2 border-black bg-black text-white hover:bg-white hover:text-black transition-colors font-bold uppercase flex items-center gap-2"
                    >
                      Next
                  ...
                  {currentStep === 4 && (
                    <>
                      <button
                        ...
                        className="px-6 py-3 border-2 border-black bg-white text-black hover:bg-black hover:text-white transition-colors font-bold uppercase"
                      >
                        Modify
                      </button>
                      ...
                      <button
                        ...
                        className="px-6 py-3 border-2 border-black bg-[#30578e] text-white hover:bg-white hover:text-[#30578e] transition-colors font-bold uppercase flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <Send size={16} />
                        Send
                      </button>
